...
.. toctree:: :maxdepth: 2
   ...
   ./communication.rst
   ./integration.rst
   Uputstvo za dev-conf <_intermediate/man/dev-conf.rst>
   ./example.rst
   ./developer.rst
...
.. todo izbaciti
   Detaljan opis postupka možete pronaći :ref:`ovdje <details>`.

U nastavku je detaljno opisan prethodni postupak. Da biste vidjeli koje opcije
podržava program ``dev-conf``, pogledajte MANPAGE.

.. todo:: ubaciti link na manpage
